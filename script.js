let validador = {
    ...
    showError:(input, error)=> {
        ...
        let errorElement = document.createElement('div') // Para criar uma tag
        errorElement.classList.add('error');
        errorElement.innerHTML = error;

        input.parentElement.insertBefore(errorElement, input.ElementSibling); //Posição onde a tag irá ficar.
    },
